...
resource "aws_cloudfront_distribution" "s3_distribution" {
  origin {
    domain_name = aws_s3_bucket_website_configuration.unified.website_endpoint
    origin_id   = "mentimeter-s3-origin"
 ...
 default_cache_behavior {
    ...
    target_origin_id = "mentimeter-s3-origin"
...
resource "aws_route53_record" "mentimeter" {
